...
`EM_BCR` <-> `MJ2K`
"""
function fc(R_x_bs, epoch::AbstractEpoch, f1::EM_BCR, f2::MJ2K)
...
function fc(I_x_ms, epoch::AbstractEpoch, f1::MJ2K, f2::EM_BCR)
...
`EM_BCR` <-> `EJ2K`
"""
function fc(R_x_bs, epoch::AbstractEpoch, f1::EM_BCR, f2::EJ2K)
...
function fc(I_x_es, epoch::AbstractEpoch, f1::EJ2K, f2::EM_BCR)
